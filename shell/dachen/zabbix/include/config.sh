...
myconfig(){
    log "Info" "安装依赖"
    yum -y install  gcc libxml2-devel bzip2-devel curl-devel libjpeg-devel libpng-devel freetype-devel pcre-devel make gcc gcc-c++ pcre-devel openssl openssl-devel ncurses-devel perl net-snmp-devel java-devel
